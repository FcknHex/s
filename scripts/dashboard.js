document.addEventListener("DOMContentLoaded", function () {
  ...
  let formHeader2 = document.querySelector(".form-header2");
  let formHeader3 = document.querySelector(".form-header3");
  let formHeader4 = document.querySelector(".form-header4");
  let formHeader5 = document.querySelector(".form-header5");
  let formHeader6 = document.querySelector(".form-header6");
  let dropdownIcon = document.querySelector(".arrow-header-icon");
  let dropdownIcon1 = document.querySelector(".arrow-header-icon1");
  let dropdownIcon2 = document.querySelector(".arrow-header-icon2");
  let dropdownIcon3 = document.querySelector(".arrow-header-icon3");
  let dropdownIcon4 = document.querySelector(".arrow-header-icon4");
  let dropdownIcon5 = document.querySelector(".arrow-header-icon5");
  let dropdownIcon6 = document.querySelector(".arrow-header-icon6");
  ...
  let collapsableContainer2 = document.querySelector(".collapsable-container2");
  let collapsableContainer3 = document.querySelector(".collapsable-container3");
  let collapsableContainer4 = document.querySelector(".collapsable-container4");
  let collapsableContainer5 = document.querySelector(".collapsable-container5");
  let collapsableContainer6 = document.querySelector(".collapsable-container6");
  ...
  formHeader2.addEventListener("click", function () {
    dropdownIcon1.style.transform =
      dropdownIcon1.style.transform === "rotate(180deg)"
        ? "rotate(0deg)"
        : "rotate(180deg)";

    collapsableContainer2.style.display =
      collapsableContainer2.style.display === "block" ? "none" : "block";
  });
  formHeader3.addEventListener("click", function () {
    dropdownIcon1.style.transform =
      dropdownIcon1.style.transform === "rotate(180deg)"
        ? "rotate(0deg)"
        : "rotate(180deg)";

    collapsableContainer3.style.display =
      collapsableContainer3.style.display === "block" ? "none" : "block";
  });
  formHeader4.addEventListener("click", function () {
    dropdownIcon1.style.transform =
      dropdownIcon1.style.transform === "rotate(180deg)"
        ? "rotate(0deg)"
        : "rotate(180deg)";

    collapsableContainer4.style.display =
      collapsableContainer4.style.display === "block" ? "none" : "block";
  });
  formHeader5.addEventListener("click", function () {
    dropdownIcon1.style.transform =
      dropdownIcon1.style.transform === "rotate(180deg)"
        ? "rotate(0deg)"
        : "rotate(180deg)";

    collapsableContainer5.style.display =
      collapsableContainer5.style.display === "block" ? "none" : "block";
  });
  formHeader6.addEventListener("click", function () {
    dropdownIcon1.style.transform =
      dropdownIcon1.style.transform === "rotate(180deg)"
        ? "rotate(0deg)"
        : "rotate(180deg)";

    collapsableContainer6.style.display =
      collapsableContainer6.style.display === "block" ? "none" : "block";
  });
